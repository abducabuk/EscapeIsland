...
{
	[Service(false)]
    public class AsyncService : BaseMonoService, IAsyncService
    {
        ...
        {			
	        if (action == null)
	        {
		        throw new ArgumentNullException(nameof(AsyncService)+"."+nameof(WaitForSecond)+"() "+nameof(action)+" is null");
	        }
		...
		public void ExecuteInFixedUpdate(System.Action action)
		{
			if (action == null)
			{
				throw new ArgumentNullException(nameof(AsyncService)+"."+nameof(ExecuteInFixedUpdate)+"() "+nameof(action)+" is null");
			}
		...
		public void ExecuteInUpdate(System.Action action)
		{
			if (action == null)
			{
				throw new ArgumentNullException(nameof(AsyncService)+"."+nameof(ExecuteInUpdate)+"() "+nameof(action)+" is null");
			}
		...
		public void ExecuteInLateUpdate(System.Action action)
		{
			if (action == null)
			{
				throw new ArgumentNullException(nameof(AsyncService)+"."+nameof(ExecuteInLateUpdate)+"() "+nameof(action)+" is null");
			}
